...
const LatestPost = () => {
   ...
   const latestPostData = data?.data || [];
   console.log('data', latestPostData);
  return (
    <>
        <div
        style={{
      ...
      <Container maxWidth="lg">
        ...
        >
          {Array.isArray(latestPostData) && latestPostData.length > 0
            ? latestPostData.map((item: latestPostProps) =>
                <Grid
                  className="card"
                  item
                  xs={12}
