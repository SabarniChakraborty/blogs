import { categoryPostQuery } from '@/customHooks/cms.query.hooks';
...
const CategoryPost = () => {
    ...
    const { data: categoryPostData, isPending: categoryPostPending, refetch: blogsRefetch } = categoryPostQuery(slug as string);
    console.log('categoryPostData', categoryPostData);
    const categoryPost = categoryPostData?.data || [];
  return (
    <div
        style={{
          marginTop: "4rem",
      ...
      >
        <Container maxWidth="lg">
          ...
          >
            {Array.isArray(categoryPost) && categoryPost.length > 0
